...
class GTransformerModel(TransformerModelBase):
    """
    GTransformerModel is a subclass of TransformerModelBase, which is a subclass of FairseqEncoderDecoderModel.
    """
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        cfg = TransformerConfig.from_namespace(args)
        return GTransformerEncoder(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        cfg = TransformerConfig.from_namespace(args)
        return GTransformerDecoder(cfg, tgt_dict, embed_tokens)
